...
class WeatherDetailScreen extends StatelessWidget {
      ...
      body: Container(
        ...
        child: SafeArea(
          child: orientation == Orientation.portrait
              ? _buildPortraitLayout(screenHeight, screenWidth, celsius,
                  minTemp, maxTemp, humidity)
              : _buildLandscapeLayout(screenHeight, screenWidth, celsius,
                  minTemp, maxTemp, humidity),
        ),
      ),
    );
  ...
  Widget _buildPortraitLayout(double screenHeight, double screenWidth,
      double celsius, double minTemp, double maxTemp, var humidity) {
    return Column(
      ...
      children: [
        ...
        Padding(
          ...
          child: Container(
            ...
            decoration: BoxDecoration(
                ...
                border:
                    Border.all(width: screenWidth * 0.005, color: Colors.white),
        ...
        _buildInfoCardPotriate(
            screenHeight, screenWidth, minTemp, maxTemp, humidity)
      ],
    );
  }
  ...
  Widget _buildInfoCard(double screenHeight, double screenWidth, double minTemp,
      double maxTemp, var humidity) {
    return Flexible(
      child: Container(
        ...
        decoration: BoxDecoration(
            borderRadius: BorderRadius.circular(30),
            border: Border.all(width: screenWidth * 0.005, color: Colors.white),
            color: Colors.transparent),
        child: Card(
          elevation: 4,
          color: Colors.transparent,
  ...
  Widget _buildInfoCardPotriate(double screenHeight, double screenWidth,
      double minTemp, double maxTemp, var humidity) {
    return Flexible(
      child: Container(
